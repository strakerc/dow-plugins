...
description: "Invoke when asked to grade, recap, or write up the rookie draft for the dynasty league — produces the annual humorous rookie draft grades writeup and, only after an explicit go-ahead, posts it to Discord #draft. Use for \"write the rookie draft grades\", \"grade the draft\", or \"post the draft grades to #draft\"."
---
