...
description: "Invoke before any league tool call for schedule questions in the Dynasty of Whiners league (MFL 29557) — who a franchise plays in a given week of any season, including a season whose schedule is not loaded yet, which scheduling tier a team is in and why, and strength of schedule. Use for \"who do I play\", \"who do I play in week N\", \"when do I play X\", \"what tier am I in\", \"how are the tiers decided\", \"scheduling tiers\", \"tier 1\", or \"who has the easiest schedule\". Read-only: the raw schedule payload is franchise ids, which this skill resolves to owners, and it never generates a schedule."
---
...
do I play". If `get_matchups` is unavailable, say the schedule tool is not
reachable — do not reach for weekly results instead.
